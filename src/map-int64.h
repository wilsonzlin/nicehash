...
#define NH_MAP_INT64_CUSTOM_NAMES(key_name, value_type, value_name)            \
	NH_MAP_INT64_CUSTOM_NAMES_DEFAULT_VALUE(key_name, value_type,          \
						value_name, 0)

#define NH_MAP_INT64_CUSTOM_NAMES_DEFAULT_VALUE(key_name, value_type,          \
						value_name, default_value)     \
	NH_MAP_CUSTOM_NAMES_DEFAULT_VALUE(                                     \
		int64_t, key_name, value_type, value_name, default_value,      \
