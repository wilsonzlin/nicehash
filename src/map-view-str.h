 ...
 */
#define _NH_MAP_VIEW_STR_PROTO(name, value_type)                               \
	NH_MAP_PROTO(name, nh_view_str*, value_type)                           \
                                                                               \
...
/**
 * Internal macro. Implement functions for a specific Map<View<char>, ?>, and
 * helper functions for using char arrays as keys directly.
 *
 * @param name name to use for the type to be declared
 * @param value_type value type
...
#define _NH_MAP_VIEW_STR_IMPL(name, value_type, default_value, fn_hash,        \
			      fn_equals)                                       \
	NH_MAP_IMPL(name, nh_view_str*, value_type, default_value, fn_hash,    \
		    fn_equals)                                                 \
                                                                               \
	value_type name##_get_whole_array(name* map, char* array,              \
					  size_t array_length)                 \
 ...
 * @param value_type value type
 */
#define NH_MAP_VIEW_STR_PROTO(name, value_type)                                \
	_NH_MAP_VIEW_STR_PROTO(name, value_type)

/**
 * Implement functions for a specific Map<View<char>, ?>.
 *
 * @param name name to use for the type to be declared
 * @param value_type value type
 * @param default_value expression evaluated when a default value is needed
 */
#define NH_MAP_VIEW_STR_IMPL(name, value_type, default_value)                  \
 ...
 * @param value_type value type
 */
#define NH_MAP_VIEW_ISTR_PROTO(name, value_type)                               \
	_NH_MAP_VIEW_STR_PROTO(name, value_type)
 ...
 * @param default_value expression evaluated when a default value is needed
 */
#define NH_MAP_VIEW_ISTR_IMPL(name, value_type, default_value)                 \
	_NH_MAP_VIEW_STR_IMPL(name, value_type, default_value,                 \
