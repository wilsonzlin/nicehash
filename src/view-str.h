...
#define NH_VIEW_STR_PROTO(name)                                                \
	NH_VIEW_PROTO(name, char)                                              \
                                                                               \
...
#define NH_VIEW_STR_IMPL(name)                                                 \
	NH_VIEW_IMPL(name, char, '\0')                                         \
                                                                               \
	int nh_view_str_compare_array_i(nh_view_str* view, char* other,        \
					size_t other_length)                   \
	{                                                                      \
		...
		return strncasecmp(&view->array[view->start], other,           \
				   view->length);                              \
	}                                                                      \
                                                                               \
	int nh_view_str_compare_i(nh_view_str* view, nh_view_str* other)       \
	{                                                                      \
		return nh_view_str_compare_array_i(                            \
			view, &other->array[other->start], other->length);     \
	}                                                                      \
                                                                               \
	bool nh_view_str_equals_array_i(nh_view_str* view, char* other,        \
					size_t other_length)                   \
	{                                                                      \
		return nh_view_str_compare_array_i(view, other, other_length)  \
		       == 0;                                                   \
	}                                                                      \
                                                                               \
	bool nh_view_str_equals_i(nh_view_str* view, nh_view_str* other)       \
