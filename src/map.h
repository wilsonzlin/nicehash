...
#define NH_MAP(key_type, value_type, fn_hash, fn_equals)                       \
	NH_MAP_CUSTOM_NAMES(key_type, key_type, value_type, value_type,        \
			    fn_hash, fn_equals)

#define NH_MAP_CUSTOM_NAMES(key_type, key_name, value_type, value_name,        \
			    fn_hash, fn_equals)                                \
	NH_MAP_CUSTOM_NAMES_DEFAULT_VALUE(key_type, key_name, value_type,      \
					  value_name, 0, fn_hash, fn_equals)

#define NH_MAP_CUSTOM_NAMES_DEFAULT_VALUE(key_type, key_name, value_type,      \
					  value_name, default_value, fn_hash,  \
					  fn_equals)                           \
